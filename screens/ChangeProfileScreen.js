import { StyleSheet, Text, View, TouchableOpacity, ImageBackground, TextInput, Alert, Image, ScrollView,  Modal } from 'react-native'
          ...
          <View style={styles.popover}>
                ...
                <TouchableOpacity onPress={pickImageAsync}>
                    <View style={styles.popoverItem}>
                        ...
                        <Text style={{ fontSize: 16, marginTop: 8, color: 'white' }}>Libraries</Text>
                    </View>
                </TouchableOpacity>
        ...
        <View style={{alignItems: 'center'}}>     
          <TouchableOpacity onPress={()=>{setOpenModal(true)}}>
            <View>
              <ImageBackground
                source={{
                  uri: image ? image : profileData? profileData.userImg? profileData.userImg:
