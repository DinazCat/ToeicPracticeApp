...
const SpeakP6QuestionForm = ({item, onRecordComplete}) => {
  ...
  return (
    ...
    {!isRecording ? (
      ...
      <TouchableOpacity style={{marginTop:'25%', alignSelf:'center', borderRadius:30, borderWidth:3, borderColor:PRIMARY_COLOR, height:60, width:60, alignItems:'center', justifyContent:'center', backgroundColor: '#CFF393'}}
